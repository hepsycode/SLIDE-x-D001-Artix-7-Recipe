...
int main (int argc, char **argv, char **env)
{
      ...
      std::string vcd_output_filename = "/home/ubuntu/Desktop/SLIDE-x-Repository/SLIDE-x/SLIDE-x-AGGR/RECIPE_INT/bsort100/files/values_98/HLS_output//simulation/test.vcd";
