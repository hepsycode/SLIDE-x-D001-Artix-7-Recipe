...
int main()
{
   ...
   __standard_exit = 0;
   __bambu_testbench_fp = fopen("/home/ubuntu/Desktop/SLIDE-x-Repository/SLIDE-x/SLIDE-x-AGGR/RECIPE_INT/bsort100/files/values_11/HLS_output//simulation/values.txt", "w");
   if (!__bambu_testbench_fp) {
      perror("can't open file: /home/ubuntu/Desktop/SLIDE-x-Repository/SLIDE-x/SLIDE-x-AGGR/RECIPE_INT/bsort100/files/values_11/HLS_output//simulation/values.txt");
      exit(1);
   }
   ...
   }
   {
      ...
      // function call
      system("/home/ubuntu/Desktop/SLIDE-x-Repository/SLIDE-x/SLIDE-x-AGGR/RECIPE_INT/bsort100/files/values_11/HLS_output//simulation/main_exec");
